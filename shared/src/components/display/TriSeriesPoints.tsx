...
import { calculateClubPoints } from '../../logic/clubPoints.js'
import type { CompetitorList } from 'server/src/router/objects.js'

interface TriSeriesPointsProps {
    competitors: CompetitorList
    maxDisplay?: number
}

export const TriSeriesPoints: FC<TriSeriesPointsProps> = ({
    competitors,
    maxDisplay = 8
}) => {
    const clubPoints = calculateClubPoints(competitors)
