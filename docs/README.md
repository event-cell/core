...
|-----|---------|----------|
| `/display/1` | Competitor leaderboard — board 1 | Cafe / lobby |
| `/display/2` | Competitor leaderboard — board 2 | Trackside |
| `/display/3` | Competitor leaderboard — board 3 | Trackside |
| `/display/4` | Competitor leaderboard — board 4 + On Track + Points | Announcer area |
| `/trackdisplay` | Live sector times for current competitor | Trackside (large TV) |
