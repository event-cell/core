...
A slider (range: 15–30, default: 25) that controls how many rows each of displays 1–3 can hold before classes overflow to display 4.
...
```
Display 1   24/25 rows   Class C Road - AWD 2001-3000cc · Class C Road - AWD over 3000cc · …
Display 2   16/25 rows   Class A Road - 2WD 1601-2000cc · …
Display 3   14/25 rows   …
Display 4   overflow     …
```
